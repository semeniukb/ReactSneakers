...
function Card({ title, price, image, addItemToBasket, addFavorite, itemId, favorite = false}) {
    ...
    return (
            <div className={styles.main__card}>
                ...
                <img className={styles.main__card_unliked} onClick={handleFavorite} src={isFavorite ?  liked : unliked} alt="Unliked"/>
                ...
                <div className={styles.main__card_price}>
                    ...
                    <img onClick={handleButtonPlus} className={styles.btn} src={isItemAdded(image) ? btnChecked : btnPlus} alt="Plus"/>
                </div>
            </div>
